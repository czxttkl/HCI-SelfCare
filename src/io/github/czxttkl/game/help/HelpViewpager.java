package io.github.czxttkl.game.help;
...
public class HelpViewpager extends Activity {
    ...
    public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			switch (arg0) {
			case 0:				
				mPage0.setImageDrawable(getResources().getDrawable(R.drawable.help_dot_now));
				...
				break;
			case 1:
				mPage1.setImageDrawable(getResources().getDrawable(R.drawable.help_dot_now));
				mPage0.setImageDrawable(getResources().getDrawable(R.drawable.help_dot));
